...
function* travelGenerator (){
    ...
    ({message, dispatch} = input); console.log('initializer', message)
    ...
    ({message, dispatch} = input); console.log('starting airport', message)
    ...
    ({message, dispatch} = input); console.log('starting airport confirmation', message)
    ...
    ({message, dispatch} = input); console.log('destination airport', message)
      dispatch(requestSendMessage("Please wait...", 2));
